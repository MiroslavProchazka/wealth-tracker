...
export const Schema = {
  ...
  property: {
    ...
    mortgageStart: Evolu.nullOr(Evolu.NonEmptyTrimmedString100),
    mortgageEnd: Evolu.nullOr(Evolu.NonEmptyTrimmedString100),
    tags: Evolu.nullOr(Evolu.TrimmedString1000),
    notes: Evolu.nullOr(Evolu.TrimmedString1000),
    deleted: Evolu.nullOr(Evolu.SqliteBoolean),
  },
  receivable: {
    ...
    dueDate: Evolu.nullOr(Evolu.NonEmptyTrimmedString100),
    tags: Evolu.nullOr(Evolu.TrimmedString1000),
    notes: Evolu.nullOr(Evolu.TrimmedString1000),
    deleted: Evolu.nullOr(Evolu.SqliteBoolean),
  },
  ...
  netWorthSnapshot: {
    ...
    snapshotDate: Evolu.NonEmptyTrimmedString100,
  ...
  cashflowEntry: {
    ...
    entryDate: Evolu.NonEmptyTrimmedString100,
  ...
  portfolioNote: {
    ...
    noteDate: Evolu.NonEmptyTrimmedString100,
